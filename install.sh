...
mkdir -p $project_root/annotation
cd $project_root/annotation
mkdir -p CityScapes/val/Dataset/Images
mkdir -p CityScapes/val/Raw
cd CityScapes/val/
...
cd $project_root/vendors/video-maskrcnn/maskrcnn_benchmark/external/tracking/SOT/SiamDW/
